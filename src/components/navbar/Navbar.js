...
export function Navbar() {
    ...
    return (
        <>
            <div onClick={animateHamburger} className=" fixed top-5 right-10 flex flex-col justify-center w-16 h-16 cursor-pointer transition ease-in-out all duration-300">
